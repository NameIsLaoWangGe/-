(function () {
    ...
    (function (_LwgEvent) {
        let PreLoad;
        (function (PreLoad) {
        })(PreLoad = _LwgEvent.PreLoad || (_LwgEvent.PreLoad = {}));
        let Guide;
        (function (Guide) {
        })(Guide = _LwgEvent.Guide || (_LwgEvent.Guide = {}));
        let Game;
        (function (Game) {
            Game["heroBlood"] = "_Game_calculateBlood";
    ...
    class _HeroWeapon extends Admin._ObjectBase {
        constructor() {
            super(...arguments);
            this.launchAcc = 0;
            this.dropAcc = 0;
            ...
            for (let index = 0; index < this._SceneImg('MiddleScenery').numChildren; index++) {
                ...
                if (element.name == 'Tree') {
                    if (this.displayArrow(element, 30)) {
                        const Pic = element.getChildByName('Blood').getChildByName('Pic');
                        const sum = 20;
                        if (element['BloodNum'] === undefined) {
                            element['BloodNum'] = sum;
                        }
                        if (element['Prowidth'] === undefined) {
                            element['Prowidth'] = Pic.width;
                        }
                        element['BloodNum'] -= 1;
                        Pic.width = Pic.width - element['Prowidth'] / sum;
                        if (element['BloodNum'] <= 0) {
    ...
    class _Hero extends Admin._ObjectBase {
        lwgOnAwake() {
