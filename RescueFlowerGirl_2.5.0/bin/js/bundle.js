(function () {
    ...
    (function (ui) {
        ...
        (function (Scene) {
            ...
            Scene.VictoryUI = VictoryUI;
            REG("ui.Scene.VictoryUI", VictoryUI);
            class _Dialog_CheckUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._Dialog_CheckUI = _Dialog_CheckUI;
            REG("ui.Scene._Dialog_CheckUI", _Dialog_CheckUI);
            class _Dialog_DoubleUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._Dialog_DoubleUI = _Dialog_DoubleUI;
            REG("ui.Scene._Dialog_DoubleUI", _Dialog_DoubleUI);
            class _Dialog_SingleUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._Dialog_SingleUI = _Dialog_SingleUI;
            REG("ui.Scene._Dialog_SingleUI", _Dialog_SingleUI);
            class _GuideUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._GuideUI = _GuideUI;
            REG("ui.Scene._GuideUI", _GuideUI);
            class _InitUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._InitUI = _InitUI;
            REG("ui.Scene._InitUI", _InitUI);
            class _ParameterUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._ParameterUI = _ParameterUI;
            REG("ui.Scene._ParameterUI", _ParameterUI);
            class _PreLoadUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
            ...
            Scene._PreLoadUI = _PreLoadUI;
            REG("ui.Scene._PreLoadUI", _PreLoadUI);
            class _PreLoadCutInUI extends View {
                constructor() { super(); }
                createChildren() {
                    super.createChildren();
    ...
    (function (LwgScene) {
        ...
        ;
        function aniFlow(openScene, closeScene) {
            let closeAniTime = 0;
            let closeScript;
            if (closeScene) {
        ...
        function openScene(openName, openData, closeName, returnBtn) {
            ...
            Laya.Scene.load('Scene/' + openName + '.json', Laya.Handler.create(this, function (scene) {
                ...
                aniFlow(openScene, LwgScene.sceneControl[closeName]);
            }));
        }
