...
export class _General {
    ...
    * @param {_ChildMove} ChildMove 子节点的移动
    */
    static _fall(Enemy: LwgNode.Image, interval1: number, interval2: number, speedY: number = 10, rSpeed: number = 0, style: string = _EnemyBullet.Type.three_Across, delay: number = 0, diffX: number = 0, frameFunc?: _FrameFunc, ChildMove?: _ChildMove): void {
     ...
     * @param {_ChildMove} ChildMove 子节点的移动
    */
    static _spiral(Enemy: LwgNode.Image, interval: number, num: number, spacingAngle: number, speed: number = 10, rSpeed: number = 0, style: string = _EnemyBullet.Type.single, delay: number = 0, diffX: number = 0, frameFunc?: _FrameFunc, ChildMove?: _ChildMove): void {
        let time = 0;
        LwgTimer.frameOnce(delay, Enemy, () => {
            LwgTimer.frameLoop(interval, Enemy, () => {
                time++;
     ...
     * @memberof _General
     */
    static _slapDown(Enemy: LwgNode.Image, interval: number = 3, startAngle: number = 0, endAngle: number = 180, spacingAngle: number = 15, speed: number = 10, rSpeed: number = 0, style: string = _EnemyBullet.Type.single, delay: number = 0, diffX: number = 0, frameFunc?: _FrameFunc, ChildMove?: _ChildMove): void {
        LwgTimer.frameOnce(delay, Enemy, () => {
            let time = 0;
            LwgTimer.frameLoop(interval, Enemy, () => {
     ...
     * @param {_ChildMove} ChildMove 子节点的移动
     */
    static _randomAngleDown(Enemy: LwgNode.Image, interval1: number, interval2: number, speed: number = 10, rSpeed: number = 0, style: string = _EnemyBullet.Type.single, delay: number = 0, diffX: number = 0, frameFunc?: _FrameFunc, ChildMove?: _ChildMove): void {
        LwgTimer.frameOnce(delay, Enemy, () => {
            LwgTimer.frameRandomLoop(interval1, interval2, Enemy, () => {
     ...
     * @memberof _General
     */
    static _evenDowByCenter(Enemy: LwgNode.Image, interval: number = 5, num: number = 2, spacing: number = 30, speed: number = 10, rSpeed: number = 0, style: string = _EnemyBullet.Type.three_Triangle, delay: number = 0, diffX: number = 0, frameFunc?: _FrameFunc, ChildMove?: _ChildMove): void {
        LwgTimer.frameOnce(delay, Enemy, () => {
     ...
     * @memberof _General
     */
    static _assignAngle(Enemy: LwgNode.Image, interval: number = 20, angle: number = 30, num: number = 2, numFrameInterval: number = 10, speed: number = 10, rSpeed: number = 0, style: string = _EnemyBullet.Type.single, delay: number = 0, diffX: number = 0, frameFunc?: _FrameFunc, ChildMove?: _ChildMove): void {
        LwgTimer.frameOnce(delay, Enemy, () => {
            LwgTimer.frameLoop(interval, Enemy, () => {
                for (let index = 0; index < num; index++) {
