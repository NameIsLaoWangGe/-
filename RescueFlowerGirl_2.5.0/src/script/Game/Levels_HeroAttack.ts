...
export class Levels_HeroAttack {
    ...
    private createWeapon(style: string, x: number, y: number): Laya.Image {
        const Weapon = LwgTools.Node.createPrefabByPool(_Res.$prefab2D.Weapon.prefab2D) as  LwgNode.Image;
