...
export module record {
    ...
    export enum memory {
        ...
        '内存的最基本原则' = '1.减少瞬时计算，2.减少对象创建，不止是节点，贴图这些显存对象，例如计时器，脚本数量，脚本中的对象属性，各种模块等等，都是消耗虚拟内存的，但是这些并不是主要的',
    ...
    */
    ...
    export let VSCode = {
        ...
        '.只能注释插件': '搜索‘智能注释’下载插件即可，注意里面的快捷键‘Document this’是一个不错的选择',
    }
    ...
    export let WritingRule = {
        ...
        LwgData$Table类中3: "方法名称首字母小写，如果涉及到了一些特殊修改的可有用add，delete，change，find",
        事件: {
    ...
    export let Issue = {
        ...
        OV: {
            ...
            5: '不分包的文件在games文件夹中',
            6: '如果打包不出dist可能是nodejs版本不对，需要nodejsv10.16.3',
            分包: {
                ...
                7: 'eclipse日志被自动清空的解决办法https://www.cnblogs.com/lenve/p/5865918.html',
            },
        },
